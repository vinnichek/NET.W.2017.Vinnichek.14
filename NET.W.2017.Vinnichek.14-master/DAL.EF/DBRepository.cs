...
namespace DAL.EF
{
    public class DBRepository : IRepository
    {
        ...
        private Owner GetAccountOwnerByName(string name, string email)
            => context.Set<Owner>().FirstOrDefault(owner => owner.Name == name && owner.Email == email);
        ...
        {
            var accountOwner = GetAccountOwnerByName(account.Owner.Name, account.Owner.Email);
